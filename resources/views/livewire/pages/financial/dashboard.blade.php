<div class="p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
            @foreach ($bankBalances as $bank)
                <div class="stats shadow bg-base-100 border border-base-300">
                    <div class="stat p-4">
                        ...
                        <div class="flex flex-col gap-0.5 mt-2 pt-2 border-t border-base-200">
            ...
            <div class="stats shadow bg-base-200 border-2 border-primary/20 text-base-content overflow-hidden">
                <div class="stat p-4">
        ...
        <!-- Gráfico Principal -->
        <div class="bg-base-100 p-6 rounded-box shadow-xl mb-12 border border-base-200" wire:ignore
            x-data="{
