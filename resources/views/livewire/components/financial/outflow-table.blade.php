                            ...
                            <div class="flex justify-end gap-1">
                                ...
                                @if ($outflow->tax_amount > 0)
                                    @if (!$outflow->expenditure)
                                        <button
                                            wire:click="$dispatch('open-expenditure-form', { fromModelType: 'App\\Models\\Outflow', fromModelId: {{ $outflow->id }}, amount: {{ $outflow->tax_amount }}, description: '{{ addslashes('Imposto Ref. ' . $outflow->description) }}' })"
